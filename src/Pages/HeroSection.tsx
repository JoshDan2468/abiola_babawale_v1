  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 z-0'>
        ...
        />
        <div className='absolute inset-0 bg-linear-to-r from-blue-900/90 to-brand-navy/80' />
      </div>

      {/* Floating Elements */}
      <motion.div
        className='absolute top-20 right-20 w-20 h-20 bg-brand-navy rounded-full blur-xl'
        animate={{
          y: [0, -50, 0],
          scale: [1, 1.2, 1],
        }}
        ...
        <div className='max-w-3xl'>
          ...
          >
            ...
            <span className='text-white font-medium'>
              Making a Difference Since 2022
            </span>
          </motion.div>
          ...
          >
            <Button
              size='lg'
              className='bg-linear-to-r from-[#2c5c39] to-[#234a2e] hover:from-[#234a2e] hover:to-[#1a3822] text-lg px-8 py-6 '
            >
              Donate Now
          ...
          >
            <div className='flex items-center gap-2 text-white'>
              ...
              <div>
                ...
                <div className='text-sm text-gray-300'>Since 2022</div>
              </div>
            </div>
            <div className='flex items-center gap-2 text-white'>
              <div className='w-12 h-12 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm'>
