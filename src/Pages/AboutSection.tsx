...
export function AboutSection() {
  return (
    <section
      id='about'
      className='py-20 bg-gradient-to-br from-blue-50 to-[#e8f0eb]'
    >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <div className='text-sm text-gray-600'>
                    Operating since 2015 with full transparency
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <p className='text-lg text-gray-700 mb-6'>
              ...
              spreading love and lending helping hands to those in need. Since
              2015, we have been committed to transforming lives and building
              sustainable communities.
            </p>
            <p className='text-lg text-gray-700 mb-8'>
              Our work spans across education, healthcare, youth empowerment,
              women development, and community building. We believe that the
              secret to happiness lies in helping others, and we're committed to
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-gray-700'>
                    ...
                    education, healthcare, and economic development, ensuring no
                    one is left behind.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-gray-700'>
                    ...
                    healthcare, and opportunities to thrive and reach their full
                    potential.
                  </p>
                </div>
              </motion.div>
            ...
            >
              <a
                href='#programs'
                className='inline-flex items-center px-6 py-3 bg-linear-to-r from-blue-600 to-[#2c5c39] text-white rounded-lg hover:from-blue-700 hover:to-[#234a2e] transition-all'
              >
